        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <div style="width: 40px; border-radius:50%; height:40px; background: url('<?= base_url("/img_users/" . user()->image); ?>') center center; background-size:70px; background-repeat:no-repeat;"></div>
