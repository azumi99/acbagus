...
<?php foreach ($viewOrder as $value) : ?>
    <div class="modal fade " id="updateModalService<?= $value->id_transaksi; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('sales/servicesave/' . $value->id_transaksi); ?>" method="POST">
