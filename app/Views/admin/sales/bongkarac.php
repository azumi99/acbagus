                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= base_url('activity/upstatus/' . $value->id_transaksi); ?>" method="POST">
                                                    ...
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#updateModalBongkar<?= $value->id_transaksi; ?>" class="btn btn-primary rounded-pill btn-sm" data-tooltip="tooltip" title="More Action">
...
<?= $this->include('admin/sales/modal/modal_bongkar'); ?>
