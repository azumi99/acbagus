...
<?= $this->section('title') ?>
acbagus.id | Admin Bongkar Pasang AC
<?= $this->endSection() ?>
<?= $this->section('content') ?>
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Bongkar Pasang AC</h1>
    </div><!-- End Page Title -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($value->status != 'Waiting') {
                                                    ...
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#detailsModal<?= $value->id_transaksi; ?>" class="btn btn-success rounded-pill btn-sm" data-tooltip="tooltip" title="Terima Booking">
                                                        <i class="fas fa-check"></i>
                                                    </button>';
                                                <?php } ?>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#updateModal<?= $value->id_transaksi; ?>" class="btn btn-primary  btn-sm" data-tooltip="tooltip" title="More Action">
...
<?= $this->include('admin/teknis_akses/modal/modal_bongkar'); ?>
<?= $this->include('admin/teknis_akses/modal/modal_savebongkar'); ?>
<?= $this->endSection() ?>